        ...
        >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, alignItems: 'center' }}>
                ...
                <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 3, alignItems: 'center', flexWrap: 'wrap', color: '#777777', fontWeight: 'normal', fontSize: '1rem', mb: 2 }}>
                        <span>@{profile.username}</span>
                        <span>#{jobTitle}</span>
                    </Box>
                    <Typography variant="body2" sx={{ fontWeight: 'light', fontSize: '0.875rem', textAlign: 'center', maxWidth: '340px' }}>
                        {Bio}
                    </Typography>
                    <Box sx={{ mt: 5 }}>

                        <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', mb: 1, fontSize: 14, fontWeight:'300' }}>
                            <IconButton sx={{ p: 0 }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#0D87DF"} fill={"none"}>
